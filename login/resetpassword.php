 <?php require_once('header.php');  ?>
    <h1 class="title-agile text-center"> Reset Password</h1>
            ...
            <form action="../codes/resetpassword_exe.php" method="post">
                <div class="field-group">
                    ...
                    <div class="wthree-field">
                        <input name="pass" id="myInput" type="Password" placeholder="New Password">
                    </div>
                </div>
                <div class="field-group">
                   
                    <div class="wthree-field">
                        <input name="cpass" id="myInput" type="Password" placeholder="Confirm Password">
                    </div>
                </div>
